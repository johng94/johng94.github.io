...
<form action='maintEmp.php' method = "post"> */
echo "beginning";
/*include("config.php");*/
session_start();
...
$newempFName = mysqli_real_escape_string($conn, $_POST['New_Emp_F_Name']);
$newempLName = mysqli_real_escape_string($conn, $_POST['New_Emp_L_Name']);
$newempRole  = mysqli_real_escape_string($conn, $_POST['New_Emp_Position']);
...
$query = "UPDATE employee
  SET employee_fname = '$newempFName',
      employee_lname = '$newempLName',
      employee_role  = '$newempRole'
